    ...
    >
      {!isFinished && !(myText[1].length == 0) && (
        <>
          ...
          <Footer className="absolute bottom-0" link="https://github.com/iamsurajchahar/typing_ace" />
        </>
      )}
      ...
      {isFinished && (
        <>
          ...
          />
          <Footer className="pt-16" link="https://github.com/iamsurajchahar/typing_ace" />
        </>
      )}
    </div>
  );
